...
public class Airplane {
    ...
    public static void compareAirplanes(Airplane plane1, Airplane plane2){
        if (plane1.length<plane2.length){
            System.out.println(plane2.manufacturer+" длиннее, чем "+plane1.manufacturer);
        }else if (plane1.length>plane2.length){
            System.out.println(plane1.manufacturer+" длиннее, чем "+plane2.manufacturer);
        }else if(plane1.length==plane2.length){
            System.out.println(plane1.manufacturer+" и "+plane2.manufacturer+" одинаковой длины.");
        }
    }
}
